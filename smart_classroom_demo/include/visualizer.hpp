...
public:
    using Ptr = std::shared_ptr<FaceVisualizer>;
    ...
    explicit FaceVisualizer(cv::Size const& imgSize, int leftPadding = 10, int rightPadding = 10, int topPadding = 75, int bottomPadding = 10);
